...
DROP POLICY IF EXISTS "reddit_sentiment_authenticated_read" ON public.reddit_sentiment;
...
DROP POLICY IF EXISTS "live_sentiment_entry_rules_authenticated_read" ON public.live_sentiment_entry_rules;
