...
DROP VIEW IF EXISTS v_today_recommendations CASCADE;
DROP VIEW IF EXISTS v_today_candidates CASCADE;
DROP VIEW IF EXISTS v_reddit_candidates_today CASCADE; 
DROP VIEW IF EXISTS v_today_live_entries CASCADE;

-- Create updated candidates view with COALESCE for consistent number display
